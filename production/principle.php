...
error_reporting(0);
$query = "SELECT * FROM employee WHERE categories = 'Principle'";
                  ...
                  ?>
                    ...
                    while($result = mysqli_fetch_assoc($data))
                    {
                        echo "<tr>
                                ...
                                <td><center><a href='update_employee_info.php?id=$result[idno]&en=$result[name]&cg=$result[categories]&ad=$result[address]&rg=$result[religion]&dob=$result[dateofbirth]&gn=$result[gender]&img=$result[image]&mn=$result[mobileno]' type='button' class='btn btn-success'><i class='far fa-edit'></i></a>
                                            <a href='delete_employee_info.php?id=$result[idno]' onclick='return checkdelete()' type='button' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
                                    </center></td>
